...
<body>
    ...
    <section id="container">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar"
                                            src="<?= ASSETS; ?>eshop/admin/img/ui-zac.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar"
                                            src="<?= ASSETS; ?>eshop/admin/img/ui-divya.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar"
                                            src="<?= ASSETS; ?>eshop/admin/img/ui-danro.jpg"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar"
                                            src="<?= ASSETS; ?>eshop/admin/img/ui-sherman.jpg"></span>
                                    <span class="subject">
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <p class="centered"><a href="profile.html"><img src="<?= ASSETS; ?>eshop/admin/img/ui-sam.jpg"
                        ...
                        <div class="row mt">
                            ...
                            <div class="col-md-4 mb">
                                ...
                                <div class="white-panel pn">
                                    ...
                                    <p><img src="<?= ASSETS; ?>eshop/admin/img/ui-zac.jpg" class="img-circle"
                                            width="80"></p>
                                    <p><b>Zac Snider</b></p>
                                    <div class="row">
                                        <div class="col-md-6">
      ...
      *********************************************************************************************************************************************************** -->
                    ...
                    <div class="col-lg-3 ds">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?= ASSETS; ?>eshop/admin/img/ui-divya.jpg" width="35px"
                                    height="35px" align="">
                            </div>
                            <div class="details">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?= ASSETS; ?>eshop/admin/img/ui-sherman.jpg" width="35px"
                                    height="35px" align="">
                            </div>
                            <div class="details">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?= ASSETS; ?>eshop/admin/img/ui-danro.jpg" width="35px"
                                    height="35px" align="">
                            </div>
                            <div class="details">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?= ASSETS; ?>eshop/admin/img/ui-zac.jpg" width="35px"
                                    height="35px" align="">
                            </div>
                            <div class="details">
                        ...
                        <div class="desc">
                            <div class="thumb">
                                <img class="img-circle" src="<?= ASSETS; ?>eshop/admin/img/ui-sam.jpg" width="35px"
                                    height="35px" align="">
                            </div>
                            <div class="details">
    ...
    $(document).ready(function() {
        var unique_id = $.gritter.add({
            ...
            image: '<?= ASSETS; ?>eshop/admin/img/ui-sam.jpg',

            ...
            <div class="col-lg-12">
                <div class="form-panel">
                    ...
                    <form action="#" class="form-horizontal style-form" method="POST" >
                        <?php if(isset($data['category_data'])):?>
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label">Tên danh mục</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="category_name" placeholder="Tên danh mục sản phẩm" value="<?= $data['category_data']->category_name?>">
                                </div>
                            </div>
                            <div class="form-group">
